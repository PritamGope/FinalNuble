  ...
  constructor($scope, $interval, $document) {
    ...
    document.addEventListener(
      ...
      function(event) {
        ...
        if (event.keyCode == 37 && isPuzzleLoad) {
          ...
          //console.log("col=",cl)
        } else if (event.keyCode == 38 && isPuzzleLoad) {
        ...
        } else if (event.keyCode == 39 && isPuzzleLoad) {
          if (cl == 0) {
            alertt();
          } else {
            $scope.moves++;
          ...
          //console.log("col=",cl)
        } else if (event.keyCode == 40 && isPuzzleLoad) {
          if (rw == 0) {
            alertt();
          } else {
            $scope.moves++;
